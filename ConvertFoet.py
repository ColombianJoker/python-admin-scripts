...
if __name__ == "__main__" :
  ...
  for Line in InputList:
    ...
    print( "%s > %s | %s > %s | %s > %s" % (Column[4], NewColumn, Column[8], FinalColumn, Column[12], Sec3))
    # OutputList.append( [ Column[:3], [NewColumn], Column[5:6], [FinalColumn], Column[9:10], [Sec3] , Column[13:] ])
    OutputList.append( [ Column[:4], [ NewColumn ], [ " * Final   * " ], [FinalColumn], Column[9:12], [ "      " + str(Sec3)  ], Column[13:] ])
