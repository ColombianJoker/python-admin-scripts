    ...
    if Opts.ForceCreateAttr:
        ...
        try:
            ...
            try:
                ...
                if Opts.Verbose:
                    sys.stderr.write(
                        '%s: Could not delete xattr for "%s"\n'
                        % (Opts.PrgName, FileName)
                    )
                else:
                    sys.stderr.write("x")
            ...
            if Opts.Verbose:
                sys.stderr.write(
                    '%s: "%s" does not have xattr, skipping...\n'
                    % (Opts.PrgName, FileName)
                )
            else:
                sys.stderr.write("-")
    ...
    if Options.Verbose:
        if Options.ForceCreateAttr:
            print(
                ...
                % (Options.PrgName, Options.AttrName)
            )
