...
parser.add_option( "-f", "--file", dest="HostsFile", action="store", help="SSH known hosts file", default="~/.ssh/known_hosts" )
parser.add_option( "-d", "--disable", dest="DisableHost", action="store", help="Disable a host" )
parser.add_option( "-e", "--enable", dest="EnableHost", action="store", help="Enable a host" )
parser.add_option( "-x", "--delete", dest="DeleteHost", action="store", help="Delete a host" )
parser.add_option( "-s", "--show", dest="ShowHost", action="store", help="Show information for a host" )
parser.add_option( "-o", "--output", dest="OutputFile", action="store", help="Output file for processed known_hosts" )
parser.add_option( "-O", "--default-output", dest="DefaultOutput", action="store_true", help="Use default .ssh/known_hosts", default=False)
parser.add_option( "-S", "--search", dest="SearchFor", action="store", help="Search and show information for hosts" )
parser.add_option( "--DEBUG", dest="DEBUG", action="store_true", help=False, default=False)
...
if Options.DEBUG:
  sys.stderr.write("*DEBUG* %s: Options.OutPutFile=%s\n" % (Options.PrgName, Options.OutputFile))
